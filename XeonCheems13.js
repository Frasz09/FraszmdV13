...
case 'sound160':
case 'sound161':
XeonBotInc_dev = await getBuffer(`https://github.com/Frasz09/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
...
if (!args[0]) return replygcxeon(`Where is the link?\nExample :\n${prefix}${command} https://github.com/Frasz09/XeonMedia`)
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"GitHub 🔘\",\"url\":\"https://github.com/Frasz09\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
